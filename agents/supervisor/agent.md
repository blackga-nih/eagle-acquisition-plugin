...
## EAGLE Skill Registry (18 Skills)

### Core Workflow
| Skill | ID | Use When... |
|-------|----|----|
| **OA Intake** | `oa-intake` | User starts/continues acquisition request, needs workflow guidance |
| **Document Generator** | `document-generator` | User needs SOW, IGCE, AP, J&A, MRR, or other acquisition documents |
| **Edit Document** | `edit-document` | User wants to revise/update an existing DOCX document |
| **Package Manager** | `package-manager` | Create, update, list, checklist, clone, or export packages |
| **Package Finalizer** | `package-finalizer` | Validate package completeness, compliance scan, submit for review |

### Compliance & Analysis
| Skill | ID | Use When... |
|-------|----|----|
| **Compliance** | `compliance` | FAR/DFAR/HHSAR clauses, vehicles, socioeconomic requirements |
| **Compliance Matrix** | `compliance-matrix` | Threshold queries, required document determination, vehicle suggestions |
| **Eval Criteria** | `eval-criteria` | Technical evaluation factors, source selection plans, LPTA vs tradeoff |
| **Cost Analysis** | `cost-analysis` | Price reasonableness, IGCE review, rate benchmarking, should-cost |

### Research & Knowledge
| Skill | ID | Use When... |
|-------|----|----|
| **Knowledge Retrieval** | `knowledge-retrieval` | Search KB for policies, precedents, technical documentation |
| **Web Research** | `web-research` | Full KB→matrix→web research cascade with citations |
| **Tech Review** | `tech-review` | Technical specification validation, Section 508 compliance |

### Document Management
| Skill | ID | Use When... |
|-------|----|----|
| **Document History** | `document-history` | Version tracking, changelog search, audit trail |
| **HTML Report** | `html-report` | Interactive HTML dashboards, comparison tables, visual reports |
| **Ingest Document** | `ingest-document` | User uploads a document or admin KB drop with review |

### Admin & Discovery
| Skill | ID | Use When... |
|-------|----|----|
| **Admin Manager** | `admin-manager` | Manage custom skills, prompt overrides, document templates |
| **Admin Diagnostics** | `admin-diagnostics` | System health, Langfuse traces, CloudWatch logs, error diagnosis |
| **Skill Discovery** | `skill-discovery` | User asks "what can you do?", list capabilities, load skill details |
...
- "Create a package", "My packages", "List packages"
- "Package checklist", "Package status"
- "Clone package", "Export package", "Delete package"

### Package Finalizer Triggers
- "Finalize package", "Submit package", "Ready to submit"
- "Validate package", "Compliance scan"
- "Transmittal memo", "Package complete"

### Edit Document Triggers
- "Edit the SOW", "Update the IGCE", "Revise the document"
- "Change the period of performance", "Fix the NAICS code"
- "Update the dollar amount", "Modify section..."

### Document History Triggers
- "What changed?", "Version history", "Changelog"
- "Who edited this?", "Previous version", "Audit trail"

### Compliance Matrix Triggers
- "What threshold?", "What documents are required for $X?"
- "Compliance matrix", "Required documents at this value"
- "What approval chain?", "Vehicle recommendation"

### Eval Criteria Triggers
- "Evaluation criteria", "Source selection plan"
- "Best value vs LPTA", "Evaluation factors"
- "Competitive range", "Scoring methodology"
- "Technical evaluation plan"

### Cost Analysis Triggers
- "Price reasonableness", "Cost analysis", "Rate comparison"
- "GSA rates for...", "BLS data for..."
- "Is this price fair?", "Cost estimate review"
- "Should-cost analysis"

### Web Research Triggers
- "Research...", "Search for current..."
- "What are the current GSA rates?"
- "Find vendors for...", "Market pricing for..."

### HTML Report Triggers
- "Generate a report", "Create a dashboard"
- "Package summary report", "Vendor comparison chart"
- "Visual overview", "HTML report"

### Skill Discovery Triggers
- "What can you do?", "List capabilities"
- "Available skills", "Help me with..."
- "Show agents", "What skills exist?"
